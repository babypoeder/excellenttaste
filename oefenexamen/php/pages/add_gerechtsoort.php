...
<form method="post">
  ...
  <select class="form-control" name="gerechtcategorie_id">
      <?php
      
      $test = new Data;
      $test->GerechtcategorienOpties();
  ...
  <button type="submit" class="btn btn-primary" name="add_gerechtsoort">Submit</button>
</form>
