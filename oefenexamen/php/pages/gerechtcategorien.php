...
<!----------------------------- NAVBAR END ------------------------->
<!----------------------------- GERECHTCATEGORIEN TABLE BEGIN ------------------------->
<a href="add_gerechtcategorie.php"><button type="button" class="btn btn-primary" style="margin: 10px">Toevoegen</button></a>
<table>
    <thead>
        <tr>
            <td><h3>Code</h3></td>
    ...
    <tbody>
            ...
            $gerechtdata = new Data();
            $gerechtdata->getGerechtcategorien();
            
            
            ?>
    </tbody>
</table>
<!----------------------------- GERECHTCATEGORIEN TABLE END ------------------------->
