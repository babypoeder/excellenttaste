...
<!----------------------------- NAVBAR END ------------------------->
<!----------------------------- GERECHTSOORTEN TABLE BEGIN ------------------------->
<a href="add_gerechtsoort.php"><button type="button" class="btn btn-primary" style="margin: 10px">Toevoegen</button></a>
<table>
    <thead>
        <tr>
            <td><h3>Code</h3></td>
    ...
    <tbody>
            ...
            $gerechtsoortdata = new Data();
            $gerechtsoortdata->getGerechtsoorten();
            
            
            ?>
    </tbody>
</table>
<!----------------------------- GERECHTSOORTEN TABLE END ------------------------->
